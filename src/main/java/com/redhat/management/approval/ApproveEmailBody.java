...
public class ApproveEmailBody implements Serializable {
    ...
    public String getRequestContentLines(HashMap<String, Object> contents) {
    ...
    public ApproveEmailBody(Request request,
            Approver approver,
            Group group,
            ArrayList<Stage> stages) {
        this.request = request;
